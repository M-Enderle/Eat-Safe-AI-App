...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF566E57);
  late Color secondary = const Color(0xFFAAB99A);
  late Color tertiary = const Color(0xFFF0F0D7);
  late Color alternate = const Color(0xFFF3F3EA);
  ...
  late Color accent2 = const Color(0xFF00BCD4);
